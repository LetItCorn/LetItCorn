  ...
  <div class="card-body container row">
    <div class="col-8" style="border-right: 1px solid #555;">
      ...
      <div class="mb-3 row">
        ...
        <div class="col-8">
          <input class="form-control text-end" min="0" :max="orderQty" v-model.number="manuFac" @input="handleManuFac"
            placeholder="생산수량" type="number" default="0">
        </div>
      ...
      <div class="mb-3 row">
        ...
        <div class="col-8">
          <input class="form-control text-end" min="0" @input="handleManuErr" :max="orderQty" v-model="manuErr"
            placeholder="불량수량" type="number" default="0">
        </div>
        <div class="col-4 py-2">
          <span>{{ processes.spec }}</span>
        </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      handleManuFac() {
        let unitCode = this.processes.unit_code;
        let maxQty = this.orderQty;
        ...
        if (unitCode === 'U03') {
          ...
          // 자동으로 불량수량 계산
          this.manuErr = maxQty - this.manuFac;
        }
      },
      ...
      handleManuErr() {
        ...
        if (unitCode === 'U03') {
          ...
          // 자동으로 생산수량 계산
          this.manuFac = maxQty - this.manuErr;
        }
      },
    },
    computed: {
